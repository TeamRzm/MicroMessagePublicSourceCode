...
- (void) configAudioKeyBoard
{
    if (!keyboardAudio)
    {
        keyboardAudio = [[UIView alloc] initWithFrame:CGRectMake(kMM_SCREEN_W / 2.0f - 129.0f / 2.0f, (KEYBOARDHEGHT - 45) / 2.0f - 72.0f / 2.0f, 129, 72.0f)];
        ...
        [_RecodeTimeLabel setFont:[UIFont fontWithName:kMM_DEFAULT_FONT_NAME size:14]];
        [_RecodeTimeLabel setTextColor:kMM_ProjectColor_StandRed];
...
- (void) configFaceKeyboard
{
    ...
    faceScroll = [[UIScrollView alloc] initWithFrame:CGRectMake(0, 0, kMM_SCREEN_W, 216)];
    ...
    [faceScroll setContentSize:CGSizeMake(kMM_SCREEN_W * pagecount, 216)];
    if (pagecount >0)
    {
        facepagecontrol = [[UIPageControl alloc] initWithFrame:CGRectMake(0.0f,faceScroll.frame.size.height-30.0f, kMM_SCREEN_W, 30.0f)];
        
        if ([[UIDevice currentDevice].systemVersion floatValue] >= 6.0f)
        {
            [facepagecontrol setCurrentPageIndicatorTintColor:kMM_ProjectColor_DeepGray];
            [facepagecontrol setPageIndicatorTintColor:kMM_ProjectColor_LightGray];
        }
        ...
        for (int h = 0; h < FACEROWCOUNT; h++)
        {
            for (int w = 0; w < FACECOLOMCOUNT; w++)
            {
                if (h*FACECOLOMCOUNT+w ==FACEPAGESIZE-2)
                {
                    ...
                    //删除
                    UIButton *Deletebt = [[UIButton alloc] initWithFrame:CGRectMake(12 + w * (kMM_SCREEN_W / FACECOLOMCOUNT)+p * kMM_SCREEN_W, 20 + h * 44, 30, 30)];
                ...
                else if (h*7+w == FACEPAGESIZE-1)
                {
                    ...
                    UIButton *sendfacebt = [[UIButton alloc] initWithFrame:CGRectMake(12 + w * (kMM_SCREEN_W / FACECOLOMCOUNT)+p * kMM_SCREEN_W, 20 + h * 44, 30, 30)];
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        [subfaceBtn setFrame:CGRectMake(10 + w * (kMM_SCREEN_W / FACECOLOMCOUNT)+ p * kMM_SCREEN_W, 20 + h * 42, 44, 44)];
...
- (void) didselectFaceBtn : (UIButton*) _sender
{
    ...
    //
    //        [self setFrame:CGRectMake(CRT_X(self), keyboardFace.frame.origin.y - (line5Size.height + 10), kMM_SCREEN_W, line5Size.height + 10)];
    //
    ...
    //
    //        [self setFrame:CGRectMake(CRT_X(self), keyboardFace.frame.origin.y - (inputTextView.contentSize.height + 10), kMM_SCREEN_W, inputTextView.contentSize.height + 10)];
    //        [self resetOtherResInputBtn];
    //        return ;
    //    }
}
...
- (void) changeKeyBoardStatus : (KEYBOARD_STATUS) _keyBoardStatus
{
    ...
    switch (currStatus)
    {
        case KEYBOARD_STATUS_NONE:
        {
            ...
            {
                oldKeyBoardFrame = CGRectMake(0, KEYBOARDHEGHT - 20 - CRT_H(self), kMM_SCREEN_W, CRT_H(self));
            }
            else
            {
                oldKeyBoardFrame = CGRectMake(0, kMM_SCREEN_H - CRT_H(self), kMM_SCREEN_W, CRT_H(self));
            }
        }
            break;
        ...
        case KEYBOARD_STATUS_AUDIO:
        {
            ...
            if (!([[UIDevice currentDevice].systemVersion floatValue] >= 7.0f))
            {
                oldKeyBoardFrame = CGRectMake(0, KEYBOARDHEGHT - 20 - 45.0f, kMM_SCREEN_W, 45.0f);
            }
            else
            {
                oldKeyBoardFrame = CGRectMake(0, kMM_SCREEN_H - 45.0f, kMM_SCREEN_W, 45.0f);
            }
        }
            break;
        ...
        case KEYBOARD_STATUS_TEXT:
        {
            if (!([[UIDevice currentDevice].systemVersion floatValue] >= 7.0f))
            {
                oldKeyBoardFrame = CGRectMake(0, KEYBOARDHEGHT - 20 - CRT_H(self), kMM_SCREEN_W,lastSelfFrame.size.height);
            }
            else
            {
                oldKeyBoardFrame = CGRectMake(0, kMM_SCREEN_H - CRT_H(self), kMM_SCREEN_W,lastSelfFrame.size.height);
            }
        }
            break;
    ...
    switch (_keyBoardStatus)
    {
        case KEYBOARD_STATUS_NONE:
        {
            ...
            if (!([[UIDevice currentDevice].systemVersion floatValue] >= 7.0f))
            {
                [keyboardFace  setFrame:CGRectMake(0, KEYBOARDHEGHT - 20, kMM_SCREEN_W, 216)];
                [keyboardOther setFrame:CGRectMake(0, KEYBOARDHEGHT - 20, kMM_SCREEN_W, 216)];
                [self setFrame:CGRectMake(0, KEYBOARDHEGHT - 20 - CRT_H(self), kMM_SCREEN_W, CRT_H(self))];
            }
            else
            {
                [keyboardFace  setFrame:CGRectMake(0, kMM_SCREEN_H, kMM_SCREEN_W, 216)];
                [keyboardOther setFrame:CGRectMake(0, kMM_SCREEN_H, kMM_SCREEN_W, 216)];
                [self setFrame:CGRectMake(0, kMM_SCREEN_H - CRT_H(self), kMM_SCREEN_W, CRT_H(self))];
            }
        ...
        case KEYBOARD_STATUS_AUDIO:
        {
            ...
            if (!([[UIDevice currentDevice].systemVersion floatValue] >= 7.0f))
            {
                [keyboardFace  setFrame:CGRectMake(0, KEYBOARDHEGHT - 20, kMM_SCREEN_W, 216)];
                [keyboardOther setFrame:CGRectMake(0, KEYBOARDHEGHT - 20, kMM_SCREEN_W, 216)];
                [self setFrame:CGRectMake(0, KEYBOARDHEGHT - 20 - 45.0f, kMM_SCREEN_W, 45.0f)];
            }
            else
            {
                [keyboardFace  setFrame:CGRectMake(0, kMM_SCREEN_H, kMM_SCREEN_W, 216)];
                [keyboardOther setFrame:CGRectMake(0, kMM_SCREEN_H, kMM_SCREEN_W, 216)];
                [self setFrame:CGRectMake(0, kMM_SCREEN_H - 45.0f, kMM_SCREEN_W, 45.0f)];
            }
            [self resetOtherResInputBtn];
        ...
        case KEYBOARD_STATUS_TEXT:
        {
            ...
            if (!([[UIDevice currentDevice].systemVersion floatValue] >= 7.0f))
                ...
                else
                {
                    [keyboardFace  setFrame:CGRectMake(0, kMM_SCREEN_H, kMM_SCREEN_W, 216)];
                    [keyboardOther setFrame:CGRectMake(0, kMM_SCREEN_H, kMM_SCREEN_W, 216)];
                    [self setFrame:CGRectMake(0, kMM_SCREEN_H - CRT_H(self) - currSysKeyboarFrame.size.height, KEYBOARDHEGHT, CRT_H(self))];
                }
        ...
        case KEYBOARD_STATUS_FACE:
        {
            ...
            if (!([[UIDevice currentDevice].systemVersion floatValue] >= 7.0f))
            {
                [keyboardFace  setFrame:CGRectMake(0, KEYBOARDHEGHT - 20 - 216, kMM_SCREEN_W, 216)];
                [keyboardOther setFrame:CGRectMake(0, KEYBOARDHEGHT - 20, kMM_SCREEN_W, 216)];
                [self setFrame:CGRectMake(0, KEYBOARDHEGHT - 20 - lastSelfFrame.size.height - 216, kMM_SCREEN_W, lastSelfFrame.size.height)];
            }
            else
            {
                [keyboardFace  setFrame:CGRectMake(0, kMM_SCREEN_H - 216, kMM_SCREEN_W, 216)];
                [keyboardOther setFrame:CGRectMake(0, kMM_SCREEN_H, kMM_SCREEN_W, 216)];
                [self setFrame:CGRectMake(0, kMM_SCREEN_H - lastSelfFrame.size.height - 216, kMM_SCREEN_W, lastSelfFrame.size.height)];
            }
            lastSelfFrame = self.frame;
         //   [audioBtn setBackgroundImage:imgAudio forState:UIControlStateNormal];
        ...
        case KEYBOARD_STATUS_OTHER:
        {
            ...
            {
                [keyboardFace  setFrame:CGRectMake(0, KEYBOARDHEGHT - 20, kMM_SCREEN_W, 216)];
                [keyboardOther setFrame:CGRectMake(0, KEYBOARDHEGHT - 20 - 216, kMM_SCREEN_W, 216)];
                [self setFrame:CGRectMake(0, KEYBOARDHEGHT - 20 - CRT_H(inputTextView) - 216-10, kMM_SCREEN_W, 10+CRT_H(inputTextView))];
            }
            else
            {
                [keyboardFace  setFrame:CGRectMake(0, kMM_SCREEN_H, kMM_SCREEN_W, 216)];
                [keyboardOther setFrame:CGRectMake(0, kMM_SCREEN_H - 216, kMM_SCREEN_W, 216)];
                [self setFrame:CGRectMake(0, kMM_SCREEN_H - CRT_H(inputTextView) - 216-10, kMM_SCREEN_W, 10+CRT_H(inputTextView))];
            }
    ...
    if (self.delegate && [self.delegate respondsToSelector:@selector(ayaKeyBoard:willChangedKeyBoardStatus:currKeyboardHeight:)])
    {
        ...
        {
            [self.delegate ayaKeyBoard:self willChangedKeyBoardStatus:currStatus currKeyboardHeight:kMM_SCREEN_H - self.frame.origin.y];
        }
    }
}
...
- (id) initWithKeyBoardTypeIsComment : (BOOL) _comment
{
    ...
    if (self)
    {
        ...
        if (!([[UIDevice currentDevice].systemVersion floatValue] >= 7.0f))
        {
            keyboardFace = [[UIView alloc] initWithFrame:CGRectMake(0, KEYBOARDHEGHT - 20, kMM_SCREEN_W, 216)];
            keyboardOther= [[UIView alloc] initWithFrame:CGRectMake(0, KEYBOARDHEGHT - 20, kMM_SCREEN_W, 216)];
        }
        else
        {
            keyboardFace = [[UIView alloc] initWithFrame:CGRectMake(0, kMM_SCREEN_H, kMM_SCREEN_W, 216)];
            keyboardOther= [[UIView alloc] initWithFrame:CGRectMake(0, kMM_SCREEN_H, kMM_SCREEN_W, 216)];
        }
        
        [keyboardFace setBackgroundColor:[UIColor whiteColor]];
        [keyboardOther setBackgroundColor:[UIColor whiteColor]];
        
        [keyboardFace setBackgroundColor:kMM_ProjectColor_BackGroundGray];
        [keyboardOther setBackgroundColor:kMM_ProjectColor_BackGroundGray];
        ...
        imgAudio    = [UIImage imageNamed:@"bottom_btn_mic"];
        imgKeyBoard = [UIImage imageNamed:@"bottom_btn_write"];
        imgFace     = [UIImage imageNamed:@"toolbar_btn_Emoji_pressed"];
        imgOther    = [UIImage imageNamed:@"bottom_btn_add"];
        
        currSysKeyboarFrame  = CGRectMake(0, KEYBOARDHEGHT, kMM_SCREEN_W, 216);
        ...
        [inputTextView setFont:[UIFont fontWithName:kMM_DEFAULT_FONT_NAME size:13.0f]];
        ...
        placeholderlabel.textColor = kMM_ProjectColor_LightGray;
        placeholderlabel.font=[UIFont fontWithName:kMM_DEFAULT_FONT_NAME size:14.0f];
        ...
        [faceBtn setFrame:CGRectMake(inputTextView.frame.origin.x + inputTextView.frame.size.width + 5.0f,
                                     45.0f / 2.0f - 44.0f / 2.0f,
                                     44.0f,
                                     44.0f)];
        [faceBtn setBackgroundImage:imgFace forState:UIControlStateNormal];
        ...
        [otherMsgBtn setFrame:CGRectMake(kMM_SCREEN_W-55.0f,
                                         45.0f / 2.0f - 44.0f / 2.0f,
                                         44.0f,
                                         44.0f)];
        ...
        [recoderBtn.layer setBorderColor:kMM_ProjectColor_LightGray.CGColor];
...
- (void) textViewDidChange:(UITextView *)textView
{
    if(textView.text.length==0)
    {
        if(self.placeholderstr.length!=0)
        {
            ...
            CGSize size=[self.placeholderstr sizeWithFont:[UIFont fontWithName:kMM_DEFAULT_FONT_NAME size:14.0f] constrainedToSize:CGSizeMake(maxwidth, 15.0f)];
    ...
    if (currStatus == KEYBOARD_STATUS_TEXT)
    {
        ...
        if (inputTextView.text.length>0)
        {
            if (textView.contentSize.height > line5Size.height)
            {
                ...
                if (!([[UIDevice currentDevice].systemVersion floatValue] >= 7.0f))
                {
                    [self setFrame:CGRectMake(0, KEYBOARDHEGHT - 20 - (line5Size.height + 10)-currSysKeyboarFrame.size.height, kMM_SCREEN_W, line5Size.height + 10)];
                }
                else
                {
                    [self setFrame:CGRectMake(0, kMM_SCREEN_H - (line5Size.height + 10)-currSysKeyboarFrame.size.height, kMM_SCREEN_W, line5Size.height + 10)];
                }
                lastSelfFrame = self.frame;
                // [self resetOtherResInputBtn];
            }
            else if (textView.contentSize.height ==35.0 )
            {
                ...
                if (!([[UIDevice currentDevice].systemVersion floatValue] >= 7.0f))
                {
                    [self setFrame:CGRectMake(0,KEYBOARDHEGHT- 20 - (inputTextView.frame.size.height + 10)-currSysKeyboarFrame.size.height, kMM_SCREEN_W, inputTextView.frame.size.height + 10)];
                }
                else
                {
                    [self setFrame:CGRectMake(0,kMM_SCREEN_H - (inputTextView.frame.size.height + 10)-currSysKeyboarFrame.size.height, kMM_SCREEN_W, inputTextView.frame.size.height + 10)];
                }
            ...
            else
            {
                ...
                if (!([[UIDevice currentDevice].systemVersion floatValue] >= 7.0f))
                {
                    [self setFrame:CGRectMake(0, KEYBOARDHEGHT  - 20 - (inputTextView.contentSize.height + 10)-currSysKeyboarFrame.size.height, kMM_SCREEN_W, inputTextView.contentSize.height + 10)];
                }
                else
                {
                    [self setFrame:CGRectMake(0, kMM_SCREEN_H - (inputTextView.contentSize.height + 10)-currSysKeyboarFrame.size.height, kMM_SCREEN_W, inputTextView.contentSize.height + 10)];
                }
                lastSelfFrame = self.frame;
                [self resetOtherResInputBtn];
            }
    ...
    else
    {
        ...
        if (inputTextView.text.length>0)
        {
            if (textView.contentSize.height > line5Size.height)
            {
                ...
                if (!([[UIDevice currentDevice].systemVersion floatValue] >= 7.0f))
                {
                    [self setFrame:CGRectMake(0,KEYBOARDHEGHT - 20 - (line5Size.height + 10)-216, kMM_SCREEN_W, line5Size.height + 10)];
                }
                else
                {
                    [self setFrame:CGRectMake(0,kMM_SCREEN_H - (line5Size.height + 10)-216, kMM_SCREEN_W, line5Size.height + 10)];
                }
                lastSelfFrame = self.frame;
                [self resetOtherResInputBtn];
            }
            else if (textView.contentSize.height ==35.0 )
            {
                ...
                if (!([[UIDevice currentDevice].systemVersion floatValue] >= 7.0f))
                {
                    [self setFrame:CGRectMake(0, KEYBOARDHEGHT- 20 - (inputTextView.frame.size.height + 10)-216, kMM_SCREEN_W, inputTextView.frame.size.height + 10)];
                }
                else
                {
                    [self setFrame:CGRectMake(0, kMM_SCREEN_H - (inputTextView.frame.size.height + 10)-216, kMM_SCREEN_W, inputTextView.frame.size.height + 10)];
                }
                lastSelfFrame = self.frame;
                [self resetOtherResInputBtn];
            }
            ...
            else
            {
                ...
                if (!([[UIDevice currentDevice].systemVersion floatValue] >= 7.0f))
                {
                    [self setFrame:CGRectMake(0, KEYBOARDHEGHT  - 20 - (textView.contentSize.height + 10)-216, kMM_SCREEN_W, textView.contentSize.height + 10)];
                }
                else
                {
                    [self setFrame:CGRectMake(0, kMM_SCREEN_H - (textView.contentSize.height + 10)-216, kMM_SCREEN_W, textView.contentSize.height + 10)];
                }
                lastSelfFrame = self.frame;
                [self resetOtherResInputBtn];
            }
        ...
        else
        {
            ...
            if (!([[UIDevice currentDevice].systemVersion floatValue] >= 7.0f))
            {
                [self setFrame:CGRectMake(0, KEYBOARDHEGHT- 20 - (inputTextView.frame.size.height + 10), kMM_SCREEN_W, inputTextView.frame.size.height + 10)];
            }
            else
            {
                [self setFrame:CGRectMake(0, kMM_SCREEN_H - (inputTextView.frame.size.height + 10), kMM_SCREEN_W, inputTextView.frame.size.height + 10)];
            }
...
{
    int page = scrollView.contentOffset.x/kMM_SCREEN_W;

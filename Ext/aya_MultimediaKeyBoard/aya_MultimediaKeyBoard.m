        ...
        for (int h = 0; h < FACEROWCOUNT; h++)
        {
            for (int w = 0; w < FACECOLOMCOUNT; w++)
            {
                if (h*FACECOLOMCOUNT+w ==FACEPAGESIZE-2)
                {
                    ...
                    //删除
                    UIButton *Deletebt = [[UIButton alloc] initWithFrame:CGRectMake(10 + w * (kMM_SCREEN_W / FACECOLOMCOUNT)+p * kMM_SCREEN_W, 20 + h * 42, 30, 30)];
                ...
                else if (h*7+w == FACEPAGESIZE-1)
                {
                    ...
                    //
                    UIButton *sendfacebt = [[UIButton alloc] initWithFrame:CGRectMake(10 + w * (kMM_SCREEN_W / FACECOLOMCOUNT)+p * kMM_SCREEN_W, 20 + h * 42, 30, 30)];
                ...
                else
                {
                    ...
                    else
                    {
                        ...
                        [subfaceBtn setFrame:CGRectMake(10 + w * (kMM_SCREEN_W / FACECOLOMCOUNT)+ p * kMM_SCREEN_W, 20 + h * 42, 30, 30)];

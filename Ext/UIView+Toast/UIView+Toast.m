...
- (UIView *)viewForMessage:(NSString *)message title:(NSString *)title image:(UIImage *)image {
    ...
    if (title != nil) {
        ...
        titleLabel.font = [UIFont fontWithName:kMM_DEFAULT_FONT_NAME size:CSToastFontSize];
    ...
    if (message != nil) {
        ...
        messageLabel.font = [UIFont fontWithName:kMM_DEFAULT_FONT_NAME size:CSToastFontSize];

...
+ (void)initialize
{
    ...
    appearance.titleFont = [UIFont fontWithName:kMM_DEFAULT_FONT_NAME_BLOD size:16.0f];

    appearance.messageColor = kMM_ProjectColor_DeepGray;
    appearance.messageFont = [UIFont fontWithName:kMM_DEFAULT_FONT_NAME_BLOD size:14.0f];
    
    appearance.buttonFont = [UIFont fontWithName:kMM_DEFAULT_FONT_NAME size:14];
...
- (UIButton *)buttonForItemIndex:(NSUInteger)index
{
    ...
    button.titleLabel.font = [UIFont fontWithName:kMM_DEFAULT_FONT_NAME_BLOD size:14.0f];

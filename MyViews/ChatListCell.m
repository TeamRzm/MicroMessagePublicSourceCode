...
-(id)initCellUnitWithModel:(id)_module className:(NSString *)_className Withdelegate:(id<ChatListCellDelegate>) _delegate
{
    ...
    if (self)
    {
        ...
        [iconimage setBackgroundColor:kMM_ProjectColor_StandWhite];
        ...
        bgimageview  = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"bg_contactbackground_others"] stretchableImageWithLeftCapWidth:9 topCapHeight:10]];
...
-(id)initRightCellUnitWithModel:(id)_module className:(NSString *)_className Withdelegate:(id<ChatListCellDelegate>) _delegate
{
    ...
    if (self)
    {
        ...
        [iconimage setFrame:CGRectMake(kMM_SCREEN_W-45.0-10.0f, 30.0f, 45.0f, 45.0f)];
        [iconimage setContentMode:UIViewContentModeScaleAspectFit];
        [iconimage setBackgroundColor:kMM_ProjectColor_LightGray];
        iconimage.layer.cornerRadius = 4.0;
        [iconimage.layer setMasksToBounds:YES];
        iconimage.userInteractionEnabled = YES;
        ...
        bgimageview = [[UIImageView alloc] initWithImage:[[UIImage imageNamed:@"bg_contactbackground_self"] stretchableImageWithLeftCapWidth:5 topCapHeight:20]];
        [bgimageview setUserInteractionEnabled:YES];
...
-(void)configCellUnitWithModel:(id)_module className:(NSString *)_className
{
    ...
    [timelb sizeToFit];
    [timelb setFrame:CGRectMake(kMM_SCREEN_W/2.0- timelb.frame.size.width/2.0f, timelb.frame.origin.y, timelb.frame.size.width, timelb.frame.size.height)];

...
- (BOOL)application:(UIApplication *)application didFinishLaunchingWithOptions:(NSDictionary *)launchOptions {
    ...
    [kMM_ProjectColor_StandBlue set];
    ...
    [[UINavigationBar appearance] setTintColor:kMM_ProjectColor_StandWhite];
    
    [[UINavigationBar appearance] setTitleTextAttributes:@{
                                                           NSForegroundColorAttributeName  : UIColorFromRGB(0xFFFFFF),
                                                           NSFontAttributeName             : [UIFont fontWithName:kMM_DEFAULT_FONT_NAME_BLOD size:18.0f],
                                                           }];
